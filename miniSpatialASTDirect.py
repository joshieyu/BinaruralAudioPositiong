...
class SoundDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Ensure the audio is in stereo and resample
        ...
        mel_spectrogram = librosa.feature.melspectrogram(y=waveform.numpy(), sr=sample_rate, n_mels=n_mels, n_fft=n_fft, hop_length=hop_length)
        ...
        # Stack the features (Mel-spectrogram + IPD)
        features = np.stack([mel_spectrogram, ipd], axis=0)  # Shape: (2, n_mels, time_steps)
